...
void analysis_template(
    TString infiles="datarec/test1/10x100/delphes.config", /* list of input files */
    ...
    TString outfilePrefix="tutorial.template.3" /* output filename prefix*/
) {
