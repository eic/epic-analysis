...
void postprocess_xqbins_stddevs_draw(
    TString infile="out/tutorial.xqbins.stddevs.root"
) {
  ...
  P->Op()->Payload(
      [&P](Histos *H) {
        ...
        P->DrawSingle(H,"Q2_Res","");
        P->DrawSingle(H,"y_Res","");
        P->DrawSingle(H,"phiH_Res","");
        P->DrawSingle(H,"phiS_Res","");
        ...
        */
        ...
        /*
        P->DrawSingle(H,"Q2vsX_q2res","COLZ");
        P->DrawSingle(H,"Q2vsX_xres","COLZ");
        P->DrawSingle(H,"Q2vsX_yres","COLZ");
        P->DrawSingle(H,"Q2vsX_zres","COLZ");
        P->DrawSingle(H,"Q2vsX_pTres","COLZ");
        P->DrawSingle(H,"Q2vsX_phiHres","COLZ");
        */

        P->DrawSingle(H,"Q2vsX_q2resSD","COLZ");
        P->DrawSingle(H,"Q2vsX_xresSD","COLZ");
        P->DrawSingle(H,"Q2vsX_yresSD","COLZ");
        P->DrawSingle(H,"Q2vsX_zresSD","COLZ");
        P->DrawSingle(H,"Q2vsX_pTresSD","COLZ");
        P->DrawSingle(H,"Q2vsX_phiHresSD","COLZ");

        P->DrawSummary(H,"Q2vsX_q2resSD","COLZ");
        P->DrawSummary(H,"Q2vsX_xresSD","COLZ");
        P->DrawSummary(H,"Q2vsX_yresSD","COLZ");
        P->DrawSummary(H,"Q2vsX_zresSD","COLZ");
        P->DrawSummary(H,"Q2vsX_pTresSD","COLZ");
        P->DrawSummary(H,"Q2vsX_phiHresSD","COLZ");
      }
      );
