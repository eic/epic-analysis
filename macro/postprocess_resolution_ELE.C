...
void postprocess_resolution_ELE(
    TString infile="out/ELE_dis-5x41.root"
){

  gROOT->ProcessLine(".! rm -v out/ELE_dis-5x41.images/*.png"); // cleanup old image files
  gROOT->ProcessLine(".! rm -v out/ELE_dis-5x41.images/*.pdf"); // cleanup old image files
