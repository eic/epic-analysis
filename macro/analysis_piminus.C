...
void analysis_piminus(
    TString configFile="datarec/epic.24.05.0/18x275/files.config", /* delphes tree(s) */
    TString outfilePrefix="piminus.10x100" /* output filename prefix*/
) {
